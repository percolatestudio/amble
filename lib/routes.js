...
AppController = RouteController.extend({
  ...
  data: function() { return { zone: this.tabNameForRoute() }; },
  layoutTemplate: 'app'
});
...
DealController = AppController.extend({
  ...
  waitOn: function () { return Meteor.subscribe('deal', this.params._id); },
...
Router.map(function() {
  ...
  this.route('deal', {path: ':zone/show/:_id', controller: 'DealController'});
});
